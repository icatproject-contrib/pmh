...
NOTE: this file has been modified in order to support ISIS ICAT oai_qdc specific metadataformat
...
<xsl:template name="quicklinks">
    <ul class="quicklinks">
      ...
      <li><a href="?verb=ListRecords&amp;metadataPrefix=oai_qdc">ListRecords</a> | </li>
      <li><a href="?verb=ListSets">ListSets</a> | </li>
      <li><a href="?verb=ListMetadataFormats">ListMetadataFormats</a> | </li>
      <li><a href="?verb=ListIdentifiers&amp;metadataPrefix=oai_qdc">ListIdentifiers</a></li>
    </ul>
</xsl:template>
...
<xsl:template match="oai:header">
  ...
  <table class="values">
    ...
    <td class="value">
      ...
      <xsl:text> </xsl:text><a class="link" href="?verb=GetRecord&amp;metadataPrefix=oai_qdc&amp;identifier={oai:identifier}">oai_qdc</a>
...
<xsl:template match="oai:setSpec">
  ...
  <td class="value"><xsl:value-of select="."/>
    <xsl:text> </xsl:text><a class="link" href="?verb=ListIdentifiers&amp;metadataPrefix=oai_qdc&amp;set={.}">Identifiers</a>
    <xsl:text> </xsl:text><a class="link" href="?verb=ListRecords&amp;metadataPrefix=oai_qdc&amp;set={.}">Records</a>
  </td></tr>
</xsl:template>
...
<xsl:template match="oai_qdc:qdc"  xmlns:oai_qdc="http://pandata.org/pmh/oai_qdc/" >
  <div class="dcdata">
    <h3>Qualified Dublin Core Metadata (oai_qdc)</h3>
    <table class="dcdata">
      <xsl:apply-templates select="*" />
    </table>
  </div>
...
<xsl:template match="dcterms:issued" xmlns:dcterms="http://purl.org/dc/terms/">
<tr><td class="key">Issued</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="dcterms:temporal" xmlns:dcterms="http://purl.org/dc/terms/">
<tr><td class="key">Temporal</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>
